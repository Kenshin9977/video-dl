...
get_gpu_encoder() {
    ...
    # TODO: get all GPU names and encoders here
    nvenc_gen_1="false"
    nvenc_gen_2="false"
    nvenc_gen_3="false"
    nvenc_gen_4="false"
...
choose_encoder() {
    ...
    if [ $nvenc_gen_1 = "true" -o $nvenc_gen_2 = "true" -o $nvenc_gen_3 = "true" -o $nvenc_gen_4 = "true" -o $nvenc_gen_5 = "true" -o $nvenc_gen_6 = "true" ]; then
        encoder="NVENC"
    elif [ $qsv_gen_1 = "true" -o $qsv_gen_2 = "true" -o $qsv_gen_3 = "true" -o $qsv_gen_4 = "true" -o $qsv_gen_5 = "true" -o $qsv_capable = "true" ]; then
        encoder="QSV"
